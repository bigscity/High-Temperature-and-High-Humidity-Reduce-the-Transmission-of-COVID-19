...
// Table 2 full time, before lockdown & after lockdown
xtfmb rt t6 h6 p_dns_norm p_over65_norm gini_norm se_factor p_icubeds_norm m50i6 home6 lat_norm lon_norm, lag(7)
xtfmb rt t6 h6 p_dns_norm p_over65_norm gini_norm se_factor p_icubeds_norm m50i6 home6 lat_norm lon_norm if day < 23, lag(3)
xtfmb rt t6 h6 p_dns_norm p_over65_norm gini_norm se_factor p_icubeds_norm m50i6 home6 lat_norm lon_norm if day >= 23, lag(7)


forvalues i = 0(1)41 {
	display `i'
	reg rt t6 h6 p_dns_norm p_over65_norm gini_norm se_factor p_icubeds_norm m50i6 home6 lat_norm lon_norm if day == `i'
	if `i' == 0 {
		matrix R = e(b)
	}
	else {
